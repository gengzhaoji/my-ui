import{_ as f,c as B,e as F,w as l,b as n,d as s,r as m,o as D,V as h}from"./app.dbb320a2.js";const x={name:"component-doc",components:{"render-demo-0":function(){const{createElementVNode:i,openBlock:k,createElementBlock:r}=h;function E(u,a){return k(),r("div",null,[i("canvas",{onMousemove:a[0]||(a[0]=(...c)=>u.mousemoveFn&&u.mousemoveFn(...c)),ref:"canvasId",width:700,height:300,style:{margin:"0 auto",background:"url('https://w.wallhaven.cc/full/we/wallhaven-we88zx.jpg')  center/cover"}},null,544)])}return{render:E,...{mounted(){this.init()},methods:{init(){let u=this.$refs.canvasId;const a=u.getContext("2d");a.fillStyle="#9c9fb3",a.fillRect(0,0,700,300),a.font="40px Arial",a.fillStyle="#333",a.fillText("\u522E\u4E00\u522E",280,150),a.globalCompositeOperation="destination-out",u.addEventListener("mousemove",t=>{t.which===1&&t.button===0&&(c(t),g(C()))});function c(t){let e=u.getBoundingClientRect(),p=t.clientX-e.left,o=t.clientY-e.top;a.beginPath(),a.arc(p,o,20,0,Math.PI*2),a.fill(),a.closePath()}function C(){let e=a.getImageData(0,0,700,300).data,p=[];for(let o=0;o<e.length;o+=4)e[o+3]<128&&p.push(e[o+3]);return(p.length/(e.length/4)*100).toFixed(2)+"%"}function g(t){t=t||0,parseInt(t)>50&&a.clearRect(0,0,700,300)}}}}}}()}},_=JSON.parse('{"title":"\u522E\u522E\u4E50\u6548\u679C","description":"","frontmatter":{},"headers":[],"relativePath":"knowledge/canvas/Scratch.md","lastUpdated":1665970642000}'),v=n("h1",{id:"\u522E\u522E\u4E50\u6548\u679C",tabindex:"-1"},[s("\u522E\u522E\u4E50\u6548\u679C "),n("a",{class:"header-anchor",href:"#\u522E\u522E\u4E50\u6548\u679C","aria-hidden":"true"},"#")],-1),A=n("p",null,[s("\u4F7F\u7528"),n("code",null,"canvas"),s("\u5B9E\u73B0\u522E\u522E\u4E50\u6548\u679C")],-1),w=n("div",null,"\u5B9E\u73B0\u522E\u522E\u4E50\u6548\u679C",-1),b=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("template")]),n("span",{class:"token punctuation"},">")]),s(`
    `),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),s("canvas")]),s(`
        `),n("span",{class:"token attr-name"},"@mousemove"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("mousemoveFn"),n("span",{class:"token punctuation"},'"')]),s(`
        `),n("span",{class:"token attr-name"},"ref"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("canvasId"),n("span",{class:"token punctuation"},'"')]),s(`
        `),n("span",{class:"token attr-name"},":width"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("700"),n("span",{class:"token punctuation"},'"')]),s(`
        `),n("span",{class:"token attr-name"},":height"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),s("300"),n("span",{class:"token punctuation"},'"')]),s(`
        `),n("span",{class:"token special-attr"},[n("span",{class:"token attr-name"},"style"),n("span",{class:"token attr-value"},[n("span",{class:"token punctuation attr-equals"},"="),n("span",{class:"token punctuation"},'"'),n("span",{class:"token value css language-css"},[n("span",{class:"token property"},"margin"),n("span",{class:"token punctuation"},":"),s("0 auto"),n("span",{class:"token punctuation"},";"),n("span",{class:"token property"},"background"),n("span",{class:"token punctuation"},":"),s(),n("span",{class:"token url"},[n("span",{class:"token function"},"url"),n("span",{class:"token punctuation"},"("),n("span",{class:"token string url"},"'https://w.wallhaven.cc/full/we/wallhaven-we88zx.jpg'"),n("span",{class:"token punctuation"},")")]),s("  center/cover"),n("span",{class:"token punctuation"},";")]),n("span",{class:"token punctuation"},'"')])]),s(`
...
`)])])],-1);function y(i,k,r,E,d,u){const a=m("render-demo-0"),c=m("demo");return D(),B("div",null,[v,A,F(c,{sourceCode:`<template>
    <canvas
        @mousemove="mousemoveFn"
        ref="canvasId"
        :width="700"
        :height="300"
        style="margin:0 auto;background: url('https://w.wallhaven.cc/full/we/wallhaven-we88zx.jpg')  center/cover;"
    />
</template>
...
<\/script>
`},{description:l(()=>[w]),highlight:l(()=>[b]),default:l(()=>[F(a)]),_:1})])}var I=f(x,[["render",y]]);export{_ as __pageData,I as default};
