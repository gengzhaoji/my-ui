import{_ as D,c as h,e as k,w as u,a as y,b as n,d as t,r as F,o as g,V as E}from"./app.14664fbb.js";const B={name:"component-doc",components:{"render-demo-0":function(){const{resolveComponent:o,createVNode:l,openBlock:c,createElementBlock:r}=E;function i(e,a){const s=o("my-table");return c(),r("div",null,[l(s,{data:e.tableData,columns:e.columns},null,8,["data","columns"])])}return{render:i,...{setup(e,{expose:a}){a();const p={columns:[{label:"\u65F6\u95F4",prop:"date"},{label:"\u540D\u79F0",prop:"name",formatter:b=>b.name.val},{label:"\u63CF\u8FF0",prop:"address"}],tableData:[{date:"2016-05-03",name:{val:"Tom"},address:"No. 189, Grove St"},{date:"2016-05-02",name:{val:"Tom2"},address:"No. 189, Grove St"}]};return Object.defineProperty(p,"__isScriptSetup",{enumerable:!1,value:!0}),p}}}}(),"render-demo-1":function(){const{resolveComponent:o,createVNode:l,withCtx:c,openBlock:r,createElementBlock:i}=E;function d(a,s){const m=o("my-table"),p=o("ClientOnly");return r(),i("div",null,[l(p,null,{default:c(()=>[l(m,{data:a.tableData,columns:a.columns,initColumns:a.initColumns,columnFilter:""},null,8,["data","columns","initColumns"])]),_:1})])}return{render:d,...{setup(a,{expose:s}){s();const C={initColumns:[{label:"\u65F6\u95F4",prop:"date",display:"always"},{label:"\u540D\u79F0",prop:"name"},{label:"\u63CF\u8FF0",prop:"address"}],columns:[{label:"\u65F6\u95F4",prop:"date",display:"always"},{label:"\u540D\u79F0",prop:"name"},{label:"\u63CF\u8FF0",prop:"address"}],tableData:[{date:"2016-05-03",name:"Tom",address:"No. 189, Grove St"},{date:"2016-05-02",name:"Tom",address:"No. 189, Grove St"}]};return Object.defineProperty(C,"__isScriptSetup",{enumerable:!1,value:!0}),C}}}}()}},V=JSON.parse('{"title":"MyTable \u8868\u683C","description":"","frontmatter":{},"headers":[{"level":2,"title":"\u4F7F\u7528columns\u6765\u5B9A\u4E49 table \u7684\u5217","slug":"\u4F7F\u7528columns\u6765\u5B9A\u4E49-table-\u7684\u5217"},{"level":2,"title":"\u4F7F\u7528columnFilter\u6765\u52A8\u6001\u5B9A\u4E49 table \u7684\u5217","slug":"\u4F7F\u7528columnfilter\u6765\u52A8\u6001\u5B9A\u4E49-table-\u7684\u5217"},{"level":2,"title":"\u6269\u5C55 Table \u5C5E\u6027","slug":"\u6269\u5C55-table-\u5C5E\u6027"},{"level":2,"title":"\u6269\u5C55 Table \u4E8B\u4EF6","slug":"\u6269\u5C55-table-\u4E8B\u4EF6"},{"level":2,"title":"\u63D2\u69FD","slug":"\u63D2\u69FD"}],"relativePath":"ui/guide/MyTable.md","lastUpdated":1698051815000}'),_=y('<h1 id="mytable-\u8868\u683C" tabindex="-1">MyTable \u8868\u683C <a class="header-anchor" href="#mytable-\u8868\u683C" aria-hidden="true">#</a></h1><p>\u5B8C\u5168\u517C\u5BB9 <a href="https://element-plus.org/zh-CN/component/table.html" target="_blank" rel="noopener noreferrer">el-table</a>\uFF0C\u6269\u5C55\u4E86\u90E8\u5206\u529F\u80FD\u3002</p><h2 id="\u4F7F\u7528columns\u6765\u5B9A\u4E49-table-\u7684\u5217" tabindex="-1">\u4F7F\u7528<code>columns</code>\u6765\u5B9A\u4E49 table \u7684\u5217 <a class="header-anchor" href="#\u4F7F\u7528columns\u6765\u5B9A\u4E49-table-\u7684\u5217" aria-hidden="true">#</a></h2>',3),A=n("div",null,[t("\u4F7F\u7528"),n("code",null,"columns"),t("\u6765\u5B9A\u4E49 table \u7684\u5217")],-1),v=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
`),n("span",{class:"token keyword"},"const"),t(" columns "),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"["),t(`
        ...
        `),n("span",{class:"token punctuation"},"{"),t(`
            ...
            `),n("span",{class:"token function-variable function"},"formatter"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"("),n("span",{class:"token parameter"},"row"),n("span",{class:"token punctuation"},")"),t(),n("span",{class:"token operator"},"=>"),t(" row"),n("span",{class:"token punctuation"},"."),t("name"),n("span",{class:"token punctuation"},"."),t("val"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token punctuation"},"{"),t(`
    ...
    tableData `),n("span",{class:"token operator"},"="),t(),n("span",{class:"token punctuation"},"["),t(`
        `),n("span",{class:"token punctuation"},"{"),t(`
            ...
            `),n("span",{class:"token literal-property property"},"name"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"{"),t(`
                `),n("span",{class:"token literal-property property"},"val"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Tom'"),n("span",{class:"token punctuation"},","),t(`
            `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(`
        ...
        `),n("span",{class:"token punctuation"},"{"),t(`
            ...
            `),n("span",{class:"token literal-property property"},"name"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token punctuation"},"{"),t(`
                `),n("span",{class:"token literal-property property"},"val"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'Tom2'"),n("span",{class:"token punctuation"},","),t(`
            `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(`
            `),n("span",{class:"token literal-property property"},"address"),n("span",{class:"token operator"},":"),t(),n("span",{class:"token string"},"'No. 189, Grove St'"),n("span",{class:"token punctuation"},","),t(`
        `),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},","),t(`
    `),n("span",{class:"token punctuation"},"]"),n("span",{class:"token punctuation"},";"),t(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),t("script")]),n("span",{class:"token punctuation"},">")]),t(`
`)])])],-1),f=n("h2",{id:"\u4F7F\u7528columnfilter\u6765\u52A8\u6001\u5B9A\u4E49-table-\u7684\u5217",tabindex:"-1"},[t("\u4F7F\u7528"),n("code",null,"columnFilter"),t("\u6765\u52A8\u6001\u5B9A\u4E49 table \u7684\u5217 "),n("a",{class:"header-anchor",href:"#\u4F7F\u7528columnfilter\u6765\u52A8\u6001\u5B9A\u4E49-table-\u7684\u5217","aria-hidden":"true"},"#")],-1),N=n("div",null,[n("code",null,"columns"),t(" \u4E2D "),n("code",null,"display"),t(" \u7684\u503C\u5305\u542B\uFF08"),n("code",null,"always"),t("\u6C38\u8FDC\u663E\u793A\uFF0C"),n("code",null,"false"),t("\u4E0D\u663E\u793A\uFF0C"),n("code",null,"true"),t("\u663E\u793A\uFF09")],-1),T=n("div",{class:"language-vue"},[n("pre",null,[n("code",null,[n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"<"),t("template")]),n("span",{class:"token punctuation"},">")]),t(`
...
<\/script>
`},{description:u(()=>[A]),highlight:u(()=>[v]),default:u(()=>[k(e)]),_:1}),f,k(a,{sourceCode:`<template>
    <ClientOnly>
...
<\/script>
`},{description:u(()=>[N]),highlight:u(()=>[T]),default:u(()=>[k(s)]),_:1}),S,w,x])}var j=D(B,[["render",G]]);export{V as __pageData,j as default};
