...
`)])])],-1);function y(i,k,r,E,d,u){const a=m("render-demo-0"),c=m("demo");return f(),D("div",null,[A,v,F(c,{sourceCode:`<template>
    <canvas @mousemove="mousemoveFn" ref="canvasId" :width="700" :height="300" style="margin:0 auto;background: url('/wallhaven-we88zx.jpg')  center/cover;" />
</template>
...
<\/script>
`},{description:l(()=>[b]),highlight:l(()=>[w]),default:l(()=>[F(a)]),_:1})])}var I=B(h,[["render",y]]);export{_ as __pageData,I as default};
