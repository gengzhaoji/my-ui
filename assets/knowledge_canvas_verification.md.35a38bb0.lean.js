...
`),n("span",{class:"token keyword"},"export"),s(),n("span",{class:"token keyword"},"default"),s(),n("span",{class:"token punctuation"},"{"),s(`
    ...
    `),n("span",{class:"token literal-property property"},"methods"),n("span",{class:"token operator"},":"),s(),n("span",{class:"token punctuation"},"{"),s(`
        ...
        `),n("span",{class:"token function"},"initImg"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),s(),n("span",{class:"token punctuation"},"{"),s(`
            ...
            img`),n("span",{class:"token punctuation"},"."),s("src "),n("span",{class:"token operator"},"="),s(),n("span",{class:"token string"},"'/wallhaven-we88zx.jpg'"),n("span",{class:"token punctuation"},";"),s(`
...
`)])])],-1);function A(e,r,d,m,h,g){const l=v("render-demo-0"),i=v("demo");return B(),C("div",null,[$,P,w(i,{sourceCode:`<template>
