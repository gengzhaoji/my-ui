...
`),n("span",{class:"token punctuation"},"}"),n("span",{class:"token punctuation"},";"),s(`
`)])]),n("span",{class:"token tag"},[n("span",{class:"token tag"},[n("span",{class:"token punctuation"},"</"),s("script")]),n("span",{class:"token punctuation"},">")]),s(`
`)])])],-1);function K(d,w,m,F,x,u){const l=C("render-demo-0"),a=C("demo"),e=C("render-demo-1"),k=C("render-demo-2"),p=C("render-demo-3");return S(),M("div",null,[$,N,f(a,{sourceCode:`<template>
...
<\/script>
`},{description:h(()=>[q]),highlight:h(()=>[Y]),default:h(()=>[f(l)]),_:1}),X,f(a,{sourceCode:`<template>
...
<\/script>
`},{description:h(()=>[L]),highlight:h(()=>[z]),default:h(()=>[f(e)]),_:1}),V,f(a,{sourceCode:`<template>
...
`},{description:h(()=>[W]),highlight:h(()=>[j]),default:h(()=>[f(k)]),_:1}),G,f(a,{sourceCode:`<template>
...
<\/script>
`},{description:h(()=>[J]),highlight:h(()=>[U]),default:h(()=>[f(p)]),_:1})])}var sn=_(O,[["render",K]]);export{nn as __pageData,sn as default};
